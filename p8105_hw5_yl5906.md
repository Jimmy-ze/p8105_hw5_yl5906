...
probability approaches 0.97. Like the theory birthday paradox.
...
power increases. When μ = 0, power is 0.05 (equal the Type I error rate
0.05). Power increases steadily, reaching 0.19 at μ = 1, 0.57 at μ = 2,
0.89 at μ = 3, and approaches 1.0 for μ ≥ 4 (power = 0.99 at μ = 4).
